...
# 查询默认公开数据
peer chaincode query -C $CHANNEL_NAME -n financial_managed_account   -c '{"function":"FindById","Args":["F766005404604841984"]}'
# 查询默认私有数据
peer chaincode query -C $CHANNEL_NAME -n financial_managed_account   -c '{"function":"FindPrivateDataById","Args":["F766005404604841984"]}'
