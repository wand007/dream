...
# 链码路径
export CC_SRC_PATH=/opt/gopath/src/github.com/hyperledger/chaincode/issue/main/
# 私有数据规则配置文件路径
export CC_CC_PATH=/opt/gopath/src/github.com/hyperledger/chaincode/issue/config/collections_config.json
# 设置golang的环境变量
...
# 打包链码
peer lifecycle chaincode package /usr/local/chaincode-artifacts/issue.tar.gz --path $CC_SRC_PATH --lang golang --label issue_1

# 安装链码
peer lifecycle chaincode install /usr/local/chaincode-artifacts/issue.tar.gz

# 将链码id设置变量,便于我们后面的使用
export CC_PACKAGE_ID=issue_1:11bb93f8da83d707f4c8827ee9a5169cb6ee0d3583d42c200e19231cc43afe49
